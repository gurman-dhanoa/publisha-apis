...
const collectionController = {
  ...
  update: catchAsync(async (req, res) => {
    ...
    res
      .status(200)
      .json(new ApiResponse(200, updated, "Collection updated successfully"));
  }),
  ...
  getByAuthor: catchAsync(async (req, res) => {
    ...
    // Extract page and limit from query, fallback to defaults
    const {page, limit} = req.query;

    const { collections, total } = await Collection.getByAuthor(authorId, {
      page,
      limit,
    });
  ...
  addArticles: catchAsync(async (req, res) => {
    ...
    res
      .status(200)
      .json(new ApiResponse(200, updated, "Articles added to collection"));
  }),
  ...
  removeArticle: catchAsync(async (req, res) => {
    ...
    res
      .status(200)
      .json(new ApiResponse(200, updated, "Article removed from collection"));
  }),
